        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">
                you said that you lost your passowrd to enter our application, so we created new passowrd for you,
                you can use this passowrd to login again and you must change it from the application, <br>
                The new password:
              </p>
            </td>
          </tr>
          ...
          <!-- start button -->
          <tr>
            <td align="left" bgcolor="#ffffff" style=" border-bottom: 3px solid #d4dadf">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
