        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 24px;">
                {{-- <img src='" border="0" style="display: block; max-width: 170px; min-width: 100px;"> --}}
            </td>
          </tr>
        </table>
        <!--[if (gte mso 9)|(IE)]>
    ...
    <tr>
        <td align="center" bgcolor="#e9ecef">
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <!-- start copy -->
            <tr>
              <td align="{{ $locale == 'ar' ? 'right' : 'left' }}" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                <p style="margin: 0;">
                    {{-- {{ isset($num) ? $num : '' }} --}}
                   @if(isset($errors) && is_array($errors) && $errors > 0)
                        @foreach ($errors as $error)
                         <a href='{{ $error }}' download='{{ $error }}' target='_blank'>{{ __('main::lang.import_report') }}</a> <br>
                        @endforeach
                   @endif
                </p>
              </td>
