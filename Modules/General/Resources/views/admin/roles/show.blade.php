        ...
        <div class="card">
          ...
          <div class="card-body">
            <ul class="list-group">
              ...
              <li class="list-group-item">
                <div class="row">
                  <strong class="col-md-3">{{ __('general::lang.permissions') }}<span class="text-danger"></span></strong>
                ...
                @foreach ($allPages as $page)
                  <div class="row">
                    <label class="col-md-3">{{ __('general::lang.'. $page) }}</label>
                    @foreach ($allActions as $action)
                      @php
          ...
          <div class="card-footer">
            ...
            @endcan
            @can('update roles')
              <a href="{{ route('admin.roles.edit', $role->id) }}" class="btn btn-warning btn-md">
