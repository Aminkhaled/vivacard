...
@section('main')
  <main class="main">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item  active"> {{ __('general::lang.aboutus') }}</li>
    </ol>
		          	...
		          	<div class="row">
		          		...
		          		<div class="col-12 col-md-2">
		          			<div class="row mb-2 mb-md-0">
		          				...
		          				<div class="col-8 col-md-12">
		          						@can('view infos')
				          					<a href="{{ route('admin.infos.show', [$info->infos_key, 'activeLocale' => $infoTrans->locale]) }}"
				          						class="btn btn-primary btn-md"><i class="fa fa-eye"></i></a>
		          						@endcan
		          						@can('update infos')
				          					<a href="{{ route('admin.infos.edit', [$info->infos_key, 'activeLocale' => $infoTrans->locale]) }}"
